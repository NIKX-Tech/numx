...
static void bench_sketch(void)
{
    ...
    for (k = 0; k < 16 * 16; k++)
        A16[k] = (k % 17 == 0) ? (float)(k / 17 + 1) : 0.0f;
    N = 100;
    t0 = now_ns();
    for (i = 0; i < N; i++)
    {
    ...
    for (k = 0; k < 32 * 32; k++)
        A32[k] = (k % 33 == 0) ? (float)(k / 33 + 1) : 0.0f;
    N = 100;
    t0 = now_ns();
    for (i = 0; i < N; i++)
    {
    ...
    for (k = 0; k < 64 * 64; k++)
        A64[k] = (k % 65 == 0) ? (float)(k / 65 + 1) : 0.0f;
    N = 100;
    t0 = now_ns();
    for (i = 0; i < N; i++)
    {
...
static void bench_cs(void)
{
    ...
    for (k = 0; k < 16 * 32; k++)
        A1632[k] = 0.0f;
    for (k = 0; k < 16; k++)
        A1632[k * 32 + k] = 1.0f; /* identity sub-block */
    for (k = 0; k < 16; k++)
        y16[k] = (float)(k % 4);
