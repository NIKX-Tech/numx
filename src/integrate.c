    ...
    numx_real_t   *result)
{
    ...
    if (n == 0 || b <= a)          return NUMX_ERR_INVALID_ARG;
    ...
    numx_real_t   *result)
{
    ...
    if (!f || !result)              return NUMX_ERR_NULL_PTR;
    if (n < 2 || (n & 1u) || b <= a) return NUMX_ERR_INVALID_ARG;
    ...
    numx_real_t   *result)
{
    ...
    switch (npts) {
    case 2: gx = GL2_X; gw = GL2_W; break;
    case 4: gx = GL4_X; gw = GL4_W; break;
    case 8: gx = GL8_X; gw = GL8_W; break;
    default: return NUMX_ERR_INVALID_ARG;
    }
