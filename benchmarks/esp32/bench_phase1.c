...
void bench_phase1(void)
{
    ...
    numx_real_t ax3[3] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)3.0};
    numx_real_t bx3[3] = {(numx_real_t)4.0, (numx_real_t)5.0, (numx_real_t)6.0};
    numx_real_t cx3[3];
    ...
    BENCH("root_bisect x^2-4 tol=1e-5", BENCH_N_SMALL,
          numx_root_bisect(f_quad, (numx_real_t)0.0, (numx_real_t)5.0, (numx_real_t)1e-5, &r));
    BENCH("root_newton x^2-4 tol=1e-5", BENCH_N_SMALL,
          numx_root_newton(f_quad, df_quad, (numx_real_t)3.0, (numx_real_t)1e-5, &r));
    BENCH("root_brent  x^2-4 tol=1e-5", BENCH_N_SMALL,
          numx_root_brent(f_quad, (numx_real_t)0.0, (numx_real_t)5.0, (numx_real_t)1e-5, &r));
    ...
    BENCH("integrate_trap n=100",    BENCH_N_MED,   numx_integrate_trap(f_xsq, (numx_real_t)0.0, (numx_real_t)1.0, 100, &r));
    BENCH("integrate_trap n=1000",   BENCH_N_SMALL, numx_integrate_trap(f_xsq, (numx_real_t)0.0, (numx_real_t)1.0, 1000, &r));
    BENCH("integrate_simpson n=100", BENCH_N_MED,   numx_integrate_simpson(f_xsq, (numx_real_t)0.0, (numx_real_t)1.0, 100, &r));
    BENCH("integrate_gauss npts=2",  BENCH_N_MED,   numx_integrate_gauss(f_xsq, (numx_real_t)0.0, (numx_real_t)1.0, 2, &r));
    BENCH("integrate_gauss npts=4",  BENCH_N_MED,   numx_integrate_gauss(f_xsq, (numx_real_t)0.0, (numx_real_t)1.0, 4, &r));
    BENCH("integrate_gauss npts=8",  BENCH_N_MED,   numx_integrate_gauss(f_xsq, (numx_real_t)0.0, (numx_real_t)1.0, 8, &r));
    ...
    for (int i = 0; i < 16; i++) {
        xsi[i] = (numx_real_t)i * ((numx_real_t)3.14159 / (numx_real_t)15.0);
        ysi[i] = xsi[i] * xsi[i];
    }
    BENCH("interp_linear n=16",            BENCH_N_MED,
          numx_interp_linear(xsi, ysi, 16, (numx_real_t)1.5, &r));
    BENCH("interp_spline_cubic n=16",      BENCH_N_MED,
          numx_interp_spline_cubic(xsi, ysi, 16, (numx_real_t)1.5, &r));
    numx_interp_spline_precompute(xsi, ysi, 16, mi);
    BENCH("interp_spline_eval (precomp)",  BENCH_N_MED,
          numx_interp_spline_eval(xsi, ysi, mi, 16, (numx_real_t)1.5, &r));
    BENCH("interp_spline_precompute n=16", BENCH_N_MED,
          numx_interp_spline_precompute(xsi, ysi, 16, mi));
    BENCH("interp_chebyshev n=8",          BENCH_N_MED,
          numx_interp_chebyshev(f_sq, 8, (numx_real_t)0.0, (numx_real_t)3.14, (numx_real_t)1.5, &r));
    BENCH("interp_chebyshev n=16",         BENCH_N_SMALL,
          numx_interp_chebyshev(f_sq, 16, (numx_real_t)0.0, (numx_real_t)3.14, (numx_real_t)1.5, &r));
    ...
    BENCH("poly_eval degree=8",           BENCH_N_BIG,
          numx_poly_eval(cp8, 8, (numx_real_t)1.5, &r));
    BENCH("poly_eval degree=3",           BENCH_N_BIG,
          numx_poly_eval(cp3, 3, (numx_real_t)2.5, &r));
    BENCH("poly_roots degree=3 tol=1e-4", BENCH_N_TINY,
          numx_poly_roots(cp3, 3, pro, &pnr, (numx_real_t)1e-4));
    ...
    BENCH("ode_rk4  decay   n=1 100-steps",  BENCH_N_SMALL,
          numx_ode_rk4(ode_decay, (numx_real_t)0.0, yo,  1, (numx_real_t)0.01, 100, yo));
    BENCH("ode_rk4  harmonic n=2 100-steps", BENCH_N_SMALL,
          numx_ode_rk4(ode_harm,  (numx_real_t)0.0, yho, 2, (numx_real_t)0.01, 100, yho));
    BENCH("ode_rk45 decay   n=1 tol=1e-4",   BENCH_N_SMALL,
          numx_ode_rk45(ode_decay, (numx_real_t)0.0, (numx_real_t)1.0, yo,  1, (numx_real_t)1e-4, yor));
    BENCH("ode_rk45 harmonic n=2 tol=1e-4",  BENCH_N_SMALL,
          numx_ode_rk45(ode_harm,  (numx_real_t)0.0, (numx_real_t)1.0, yho, 2, (numx_real_t)1e-4, yor2));
}
